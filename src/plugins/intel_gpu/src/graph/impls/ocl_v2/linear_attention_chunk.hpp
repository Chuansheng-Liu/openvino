...
struct LinearAttentionChunk : public ImplementationManager {
    OV_GPU_PRIMITIVE_IMPL("ocl::linear_attention::chunk")
    explicit LinearAttentionChunk(shape_types shape_type, ValidateFunc vf = nullptr) : ImplementationManager(impl_types::ocl, shape_type, std::move(vf)) {}
    ...
    [[nodiscard]] bool validate_impl(const program_node& node) const override {
        ...
        static const bool chunk_enabled = [] {
            const char* env = std::getenv("OV_GENAI_USE_CHUNK_LINEAR_ATTN");
